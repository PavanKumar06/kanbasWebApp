...
//                 Add
//               </button>
//               <button className="btn btn-secondary module-title" onClick={handleUpdateModule}>
//                 Update
//               </button>
//             </div>
//           </div>
...
//           .map((mod, index) => (
//             <li key={index} className="list-group-item wd-module-item module-item">
//               <h3 className="wd-module-title module-title">{mod.name}</h3>
//               <p className="wd-module-description module-description">{mod.description}</p>
//               <div className="wd-module-actions module-title">
//                 <button
